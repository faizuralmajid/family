            ...
            <div class="content__boxed">
                <div class="content__wrap container">
                    <div class="mt-4 d-grid gap-2 d-md-block">
                        <a href="https://dev-famday.air.id/events/list"><button class="btn btn-light btn-sm"
                                type="button">Berlangsung</button></a>
                        <a href="https://dev-famday.air.id/events/list/cs"><button class="btn btn-light btn-sm ml-2"
                                type="button">Segera</button></a>
                        <a href="https://dev-famday.air.id/events/list/end"><button
                                class="btn btn-bg-purple btn-sm ml-2" type="button">Berakhir</button></a>
                    </div>
                    <div class="row mt-3">
                                    ...
                                    <div class="text-center position-relative box">
                                        <div class="pb-3">
                                            <div class="container-img">
                                                <img class="img-lg bannernya "
                                                    src="https://dev-famday.air.id/storage/files/1664984823_Screenshot_2.jpg"
                                ...
                                <div class="card-body p-0">
                                    <div class="text-center position-relative box">
                                        <div class="pb-3">
                                            <div class="container-img">
                                                <img class="img-lg bannernya"
                                                    src="https://dev-famday.air.id/img/logo.png" alt="Logo Picture"
                                                    loading="lazy">
                                            </div>
                                        </div>
                ...
                <div class="modal-body ">
                    <div class="row justify-content-center">
                        <div class="col-6">
                            ...
                            <form id="createEvents" class="mt-2" action="https://dev-famday.air.id/events/create"
                                method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="_token"
                                    value="64dt7QFU6cYTzqlrzd42AVMPScfZ6K47MHyCcZud"> <label
                                    class="row text-dark fw-bolder">Banner Acara</label>
